...
dir = Path(r'E:\0.4Program-Code\3.YOLOv5-uav-adversarial\yolov5_adversarial-master\yolov5_adversarial-master\data\visdrone_data')  # dataset文件夹下Visdrone2019文件夹路径
# Convert
