#https://blog.csdn.net/ren9855/article/details/131352584
"""
该脚本用于visdrone数据处理；
...
if __name__ == '__main__':
    ...
    txt_folder = 'E:\\0.4Program-Code\\3.YOLOv5-uav-adversarial\\yolov5_adversarial-master\\yolov5_adversarial-master\\data\\VisDrone2019-DET-train\\annotations'  # visdrone txt标签文件夹
    txt_file = os.listdir(txt_folder)
    img_folder = 'E:\\0.4Program-Code\\3.YOLOv5-uav-adversarial\\yolov5_adversarial-master\\yolov5_adversarial-master\\data\\VisDrone2019-DET-train\\images'  # visdrone 照片所在文件夹
    count = 0
    for txt in txt_file:
